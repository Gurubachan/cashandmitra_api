                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="about-content">
                            <h3 class="head3">Why choose our world fast online payment services.</h3>
                            <p class="hidden-sm head3"> Minim liber accusata pro ne, mea id quot apeirian lisque. No melius nusquam sentias eam, usu ex prima iriure. Cum velit dolorum scaevola ea, ex eos debitis omittantur</p>
                            <div class="about-details">
                                <div class="single-about">
                                    <a href="#"><i class="flaticon-079-graphic"></i></a>
                                    <div class="icon-text">
                                        <h5 class="head3">Low Costing</h5>
                                        <p class="head3">The phrasal sequence of the Lorem Ipsum text is now so widespread that many the starting sequence</p>
                                    </div>
                                </div>
                                <div class="single-about">
                                    <a href="#"><i class="flaticon-007-document-2"></i></a>
                                    <div class="icon-text">
                                        <h5 class="head3">Safe & Secure</h5>
                                        <p class="head3">The phrasal sequence of the Lorem Ipsum text is now so widespread that many the starting sequence</p>
                                    </div>
                                </div>
                                <div class="single-about">
                                    ...
                                    <div class="icon-text">
                                        <h5 class="head3">Live Support</h5>
                                        <p class="head3">The phrasal sequence of the Lorem Ipsum text is now so widespread that many the starting sequence</p>
                                    </div>
                                </div>
                            </div>
               ...
               <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="section-headline text-center">
							<h2 class="head2">Customer Reviews</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="overview-text">
                            <h3 class="head3">Secure online shopping world top brand product </h3>
						    <p class="head3">Replacing a  maintains the amount of lines. When replacing a selection. help agencies to define their new business objectives and then create</p>
                            <ul>
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="download-text">
						    <h3 class="real">Download our apps of your mobile phone for service</h3>
						    <p class="head3">Replacing a  maintains the amount of lines. When replacing a selection. help agencies to define their new business objectives and then createReplacing a  maintains the amount of lines. When replacing a selection. help agencies to define their new business objectives and then createReplacing a  maintains the amount of lines. When replacing a selection. help agencies to define their new business objectives and then create</p>
